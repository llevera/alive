...
from openai import NOT_GIVEN, NotGiven, OpenAI, AzureOpenAI
...
# Azure OpenAI specific user classes
class AzureGPT4User(OpenAIAPIUser):
    model_name = "gpt-4"


class AzureGPT4oUser(OpenAIAPIUser):
    model_name = "gpt-4o"


class AzureGPT4oMiniUser(OpenAIAPIUser):
    model_name = "gpt-4o-mini"


class AzureGPT35TurboUser(OpenAIAPIUser):
